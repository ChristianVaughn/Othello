...
<body onload="renderLevel(8);">
	...
	<div id="main" class="container">
		...
		<section id="game-options">
			...
			<br>
			<br>
			<button aria-label="4x4 Board" onclick="renderLevel(4);">4x4</button>
			<button aria-label="6x6 Board" onclick="renderLevel(6);">6x6</button>
			<button aria-label="8x8 Board" onclick="renderLevel(8);">8x8</button>
			<br>
			...
			<div aria-label="BoardColor" class="input-color-container">
			...
			<div aria-label="P1Color" class="input-color-container">
			...
			<br>
			<button aria-label="start" onclick="gameStart();">start</button>
		</section>
		<section>
